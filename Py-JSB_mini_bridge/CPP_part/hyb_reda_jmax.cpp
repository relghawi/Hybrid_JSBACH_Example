#include "hyb_reda_jmax.h"

using namespace std;

Hyb_jsb_jmax::Hyb_jsb_jmax(char* path){

    model = load_model(path);

}

float Hyb_jsb_jmax::forward(float apar_acc_tile, float CO2_flux_net, float rad_sw_down, 
